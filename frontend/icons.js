...
const iconHtmls = {
    ...
    "Target": '<div class="icon-background icon-symbol"><i class="fas fa-crosshairs" style="padding-left: 2px; padding-top: 2px; font-size: 20px; color: #212d3c;"></i><div>',
    ...
    "SAM": '<div class="icon-background icon-symbol"><i class="fas fa-exclamation-circle" style="padding-left: 1px; padding-top: 2px; font-size: 20px; color: #212d3c;"></i><div>',
    "HomeBase": '<div class="icon-background icon-symbol"><i class="fas fa-home" style="padding-left: 1px; padding-top: 2px; font-size: 20px; color: #212d3c;"></i><div>',
    ...
    "ContestedArea": '<div class="icon-background icon-symbol"><i class="fab fa-fort-awesome" style="padding-left: 2px; padding-top: 2px; font-size: 20px; color: #212d3c;"></i><div>',
    "Bullseye": '<div class="icon-background icon-symbol"><i class="fas fa-bullseye" style="padding-left: 2px; padding-top: 2px; font-size: 20px; color: #212d3c;"></i><div>',
...
const iconSelectedHtmls = {
    ...
    "Target": '<div class="icon-background-selected icon-symbol"><i class="fas fa-crosshairs" style="padding-left: 2px; padding-top: 2px; font-size: 20px; color: #EEEEEE;"></i><div>',
    ...
    "SAM": '<div class="icon-background-selected icon-symbol"><i class="fas fa-exclamation-circle" style="padding-left: 1px; padding-top: 2px; font-size: 20px; color: #EEEEEE;"></i><div>',
    "HomeBase": '<div class="icon-background-selected icon-symbol"><i class="fas fa-home" style="padding-left: 1px; padding-top: 2px; font-size: 20px; color: #EEEEEE;"></i><div>',
    ...
    "ContestedArea": '<div class="icon-background-selected icon-symbol"><i class="fab fa-fort-awesome" style="padding-left: 2px; padding-top: 2px; font-size: 20px; color: #EEEEEE;"></i><div>',
    "Bullseye": '<div class="icon-background-selected icon-symbol"><i class="fas fa-bullseye" style="padding-left: 2px; padding-top: 2px; font-size: 20px; color: #EEEEEE;"></i><div>',
